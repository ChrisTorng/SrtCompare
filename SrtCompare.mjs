...
// 比較兩個字幕陣列，並輸出差異
function compareAndPrintDifferences(srt1, srt2) {
    let i = 0;
    let j = 0;
...
function compareLines(i, offset1, j, offset2, line1, line2) {
...
function getDifferences(i, offset1, j, offset2, str1, str2) {
